...
Sin `-v`, pytest muestra solo un punto por test que pasa; con `-v`, el nombre de cada uno.
...
<details>
<summary>Ver los 47 tests</summary>

```
tests/test_evaluate.py::test_metricas_por_pregunta PASSED
tests/test_evaluate.py::test_precision_divide_por_k_aunque_vengan_menos_resultados PASSED
tests/test_evaluate.py::test_sin_acierto PASSED
tests/test_evaluate.py::test_summarize_promedia PASSED
tests/test_evaluate.py::test_evaluate_usa_doc_id_de_la_metadata PASSED
tests/test_evaluate.py::test_golden_set_real_tiene_5_preguntas_con_documentos_existentes PASSED
tests/test_evaluate.py::test_golden_set_invalido PASSED
tests/test_ingestion.py::test_clean_markdown_quita_anclas_e_includes PASSED
tests/test_ingestion.py::test_section_at_devuelve_ultimo_encabezado_previo PASSED
tests/test_ingestion.py::test_load_documents_asigna_doc_id_fuente_y_categoria PASSED
tests/test_ingestion.py::test_split_documents_respeta_tamanio_y_esquema_de_metadata PASSED
tests/test_ingestion.py::test_upsert_por_lotes_con_texto_en_metadata PASSED
tests/test_ingestion.py::test_upsert_rechaza_dimension_incorrecta PASSED
tests/test_ingestion.py::test_upsert_reintenta_errores_transitorios PASSED
tests/test_ingestion.py::test_upsert_se_rinde_tras_max_reintentos PASSED
tests/test_ingestion.py::test_namespace_count_lee_stats_del_namespace PASSED
tests/test_rag_system.py::test_tokenizer_conserva_identificadores_y_quita_stopwords PASSED
tests/test_rag_system.py::test_tokenizer_ignora_tildes PASSED
tests/test_rag_system.py::test_bm25_matchea_nombres_tecnicos_exactos PASSED
tests/test_rag_system.py::test_corpus_bm25_se_reconstruye_desde_metadata_de_pinecone PASSED
tests/test_rag_system.py::test_cumple_filtro_sintaxis_pinecone[None-True] PASSED
tests/test_rag_system.py::test_cumple_filtro_sintaxis_pinecone[filtro1-True] PASSED
tests/test_rag_system.py::test_cumple_filtro_sintaxis_pinecone[filtro2-True] PASSED
tests/test_rag_system.py::test_cumple_filtro_sintaxis_pinecone[filtro3-False] PASSED
tests/test_rag_system.py::test_cumple_filtro_sintaxis_pinecone[filtro4-True] PASSED
tests/test_rag_system.py::test_cumple_filtro_sintaxis_pinecone[filtro5-False] PASSED
tests/test_rag_system.py::test_cumple_filtro_sintaxis_pinecone[filtro6-True] PASSED
tests/test_rag_system.py::test_cumple_filtro_sintaxis_pinecone[filtro7-False] PASSED
tests/test_rag_system.py::test_cumple_filtro_sintaxis_pinecone[filtro8-False] PASSED
tests/test_rag_system.py::test_cumple_filtro_sintaxis_pinecone[filtro9-True] PASSED
tests/test_rag_system.py::test_cumple_filtro_sintaxis_pinecone[filtro10-False] PASSED
tests/test_rag_system.py::test_cumple_filtro_sintaxis_pinecone[filtro11-False] PASSED
tests/test_rag_system.py::test_cumple_filtro_rechaza_operador_desconocido PASSED
tests/test_rag_system.py::test_retrieve_sin_filtro_usa_todo_el_corpus PASSED
tests/test_rag_system.py::test_retrieve_con_filtro_solo_devuelve_chunks_que_cumplen PASSED
tests/test_rag_system.py::test_bm25_filtra_antes_de_cortar_el_top_k PASSED
tests/test_rag_system.py::test_bm25_descarta_chunks_sin_terminos_en_comun PASSED
tests/test_rag_system.py::test_filtro_sin_coincidencias_devuelve_lista_vacia PASSED
tests/test_rag_system.py::test_pregunta_fuera_del_dominio_devuelve_lista_vacia PASSED
tests/test_rag_system.py::test_retrieve_con_scores_mismo_orden_que_retrieve_y_score_rrf PASSED
tests/test_rag_system.py::test_retrieve_con_scores_respeta_el_filtro PASSED
tests/test_rag_system.py::test_resultado_json_incluye_metadata_score_y_namespace PASSED
tests/test_rag_system.py::test_resultado_json_sin_resultados_explica_por_que PASSED
tests/test_setup_index.py::test_crea_indice_serverless_si_no_existe PASSED
tests/test_setup_index.py::test_no_recrea_indice_existente PASSED
tests/test_setup_index.py::test_detecta_mismatch_de_dimensiones PASSED
tests/test_setup_index.py::test_detecta_metrica_distinta PASSED
47 passed in 2.93s
```
